...
int sr_nat_is_iface_internal(char *);
int generate_unique_port(struct sr_nat *);
int generate_unique_icmp_identifier(struct sr_nat *);
...
void destroy_tcp_conn(struct sr_nat_mapping *, struct sr_nat_connection *);
void destroy_nat_mapping(struct sr_nat *, struct sr_nat_mapping *);
